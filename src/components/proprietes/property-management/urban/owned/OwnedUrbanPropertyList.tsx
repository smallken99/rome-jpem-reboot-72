...
import { Building2, Building, Map, Landmark } from "lucide-react";
import { OwnedBuilding } from "@/components/proprietes/hooks/building/types";
import { formatCurrency } from "@/utils/formatters";

interface OwnedUrbanPropertyListProps {
  buildings: OwnedBuilding[];
  onSelectBuilding: (id: string) => void;
}

export const OwnedUrbanPropertyList: React.FC<OwnedUrbanPropertyListProps> = ({
  buildings,
  onSelectBuilding
}) => {
